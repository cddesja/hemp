...
#' Teachers' Grading Consistency in a Performance Assessment
#'
...
#' Fabricated Multiple-Choice Test
#'
#' This fabricated multiple-choice test consists of 27 items administered to 496 examinees. The data were randomly generated to demonstrate various psychometric models (e.g., 2PL-NLM and 3PL-NLM).
#'
#' @docType data
#' @keywords dataset
#' @format A data frame in wide-format with 496 examinees' responses to 27 items.
...
#' Multidimensional MIMIC Data Set
#'
...
#' }
#' @source Lee, S., Bulut, O., & Suh, Y. (2016). Multidimensional extension of multiple indicators multiple causes models to detect DIF. Educational and Psychological Measurement. Advance online publication. doi:10.1177/0013164416651116
"mimic"


#' Fabricated Multidimensional Depression Scale
#'
